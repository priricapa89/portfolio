...
export function TopicsSection() {
  return (
    <section className="topics" id="topics">
      <SectionHeader
        pill="Topics & Content"
        heading={<>The conversations <em>I live inside</em></>}
        intro="Each card links to my actual analysis on LinkedIn — posts and short videos where I break these ideas down in plain language."
      />
